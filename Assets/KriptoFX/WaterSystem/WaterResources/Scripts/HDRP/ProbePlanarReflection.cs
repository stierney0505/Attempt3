...
namespace KWS
{
    public class ProbePlanarReflection: ReflectionPass
    {
        ...
        void UpdateRT()
        {
            ...
            if (_waterInstance.Settings.UseAnisotropicReflections) _waterInstance.SharedData.PlanarReflectionRaw = _currentPlanarRT;
            else _waterInstance.SharedData.PlanarReflectionFinal                                                 = _currentPlanarRT;
        }
        ...
        void UpdateProbeSettings(WaterSystem waterInstance)
        {
            ...
            //_probe.settingsRaw.resolutionScalable                     = new ProbeSettings.PlanarReflectionAtlasResolutionScalableSettingValue();
